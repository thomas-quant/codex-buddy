...
use buddy_wrapper::buddy::types::{EYES, HATS, RARITIES, SPECIES, STAT_NAMES};
use std::collections::BTreeMap;

fn utf16_reference_roll(seed: &str) -> buddy_wrapper::buddy::types::Roll {
    ...
    let bones = buddy_wrapper::buddy::types::CompanionBones {
    ...
    buddy_wrapper::buddy::types::Roll {
        bones,
...
#[test]
fn non_ascii_seed_uses_utf16_code_units_like_typescript() {
    let seed = "duck-🦆-café";
    assert_eq!(roll_with_seed(seed), utf16_reference_roll(seed));
}
